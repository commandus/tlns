...
static esp_ip4_addr_t wifi_sta_ipv4_addr;
...
)
{
    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        wifi_sta_ipv4_addr = event->ip_info.ip;
        s_retry_num = 0;
        xEventGroupSetBits(s_wifi_event_group, WIFI_CONNECTED_BIT);
    }
}

esp_ip4_addr_t wifiStationInit()
{

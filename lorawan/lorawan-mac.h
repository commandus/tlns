...
#define MAC_RESET_SIZE 2
#define MAC_LINK_CHECK_SIZE 3
#define MAC_LINK_ADR_REQ_SIZE 5
#define MAC_LINK_ADR_RESP_SIZE 2
#define MAC_DUTY_CYCLE_SIZE 2
#define MAC_RXRARAMSETUP_REQ_SIZE 5
#define MAC_RXRARAMSETUP_RESP_SIZE 2
#define MAC_DEVSTATUS_SIZE 3
#define MAC_NEWCHANNEL_REQ_SIZE 6
#define MAC_NEWCHANNEL_RESP_SIZE 2
#define MAC_TIMINGSETUP_SIZE 2
#define MAC_TXPARAMSETUP_SIZE 2
#define MAC_DLCHANNEL_REQ_SIZE 5
#define MAC_DLCHANNEL_RESP_SIZE 2
#define MAC_REKEY_REQ_SIZE 2
#define MAC_REKEY_RESP_SIZE 2
#define MAC_ADRPARAMSETUP_SIZE 2
#define MAC_DEVICETIME_SIZE 4
#define MAC_FORCEREJOIN_SIZE 3
#define MAC_REJOINPARAMSETUP_REQ_SIZE 2
#define MAC_REJOINPARAMSETUP_RESP_SIZE 2
#define MAC_PINGSLOTINFO_SIZE 2
#define MAC_PINGSLOTCHANNEL_REQ_SIZE 5
#define MAC_PINGSLOTCHANNEL_RESP_SIZE 2
#define MAC_BEACONTIMING_SIZE 4
#define MAC_BEACONFREQUENCY_REQ_SIZE 4
#define MAC_BEACONFREQUENCY_RESP_SIZE 2
#define MAC_DEVICEMODE_SIZE 2

    ...
    switch(com_type) {
        case LGW_COM_SPI:
            ...
            if (spi_stat != LGW_SPI_SUCCESS) {
                ERROR_PRINTF("ERROR: %s: Failed to connect to sx1261 radio on %s\n", __FUNCTION__, com_path);
        ...
        case LGW_COM_USB:
            ...
            DEBUG_PRINTF("SX1261: connected with USB\n");
            break;
        default:
            ERROR_PRINTF("ERROR: %s: wrong COM type\n", __FUNCTION__);
            return LGW_COM_ERROR;
    }
...
int sx1261_com_close(void) {
    ...
    switch(_sx1261_com_type) {
        case LGW_COM_SPI:
            ...
            if (spi_stat != LGW_SPI_SUCCESS) {
                ERROR_PRINTF("ERROR: %s: Failed to disconnect SX1261 radio\n", __FUNCTION__);
                return LGW_COM_ERROR;
            }
            break;
        case LGW_COM_USB:
            break;
        default:
            ERROR_PRINTF("ERROR: %s: sx1261 not connected\n", __FUNCTION__);
            return LGW_COM_ERROR;
    }
